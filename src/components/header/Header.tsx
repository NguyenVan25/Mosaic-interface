        ...
        {isMd ? (
          <>
            ...
            {connected ? (
              ...
              <>
                <Button
                  className="bg-[#faca20]px-2 h-[32px] w-fit min-w-fit rounded-lg py-0 font-normal text-[#2e3337]"
                ...
                <ModalConnectWallet
                  ...
                  onOpenChange={handleCloseWalletModal}
                />
              </>
            )}
          </>
          ...
          <>
            ...
            <div className="w-[200px] text-end">
              {connected ? (
                ...
                <>
                  <Button
                    className="h-[32px] w-fit min-w-fit rounded-lg bg-[#faca20] px-2 py-0 font-normal text-[#2e3337]"
                    onPress={handleOpenWalletModal}
                  >
                    Connect wallet
                  </Button>
